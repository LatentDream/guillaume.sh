...
import flojoySequencerImage from '@/assets/cv/flojoy-sequencer.png?url';
import flojoyStudioImage from '@/assets/cv/flojoy-studio.png?url';
import bedOfNailImage from '@/assets/cv/bed-of-nail.png?url';
import PreComputeImage from '@/assets/cv/pre-compute.png?url';
import PostComputeImage from '@/assets/cv/post-compute.png?url';
import duckietownGif1 from '@/assets/cv/duckietown_1.gif?url';
import duckietownGif3 from '@/assets/cv/duckietown_3.gif?url';
import duckietownGif4 from '@/assets/cv/duckietown_4.gif?url';
import q_demo from '@/assets/cv/q_demo.gif?url';
import q_demo2 from '@/assets/cv/q_demo_2.gif?url';
import watsonImage from '@/assets/cv/watson.png?url';
import watsonImage2 from '@/assets/cv/watson2.png?url';
import wav from '@/assets/cv/wav.png?url';
import bitmap from '@/assets/cv/bitmap.png?url?url';
import x86 from '@/assets/cv/x86.png?url';
